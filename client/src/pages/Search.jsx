...
export default function Search() {
  ...
  useEffect(() => {
    ...
    const totalBeds = Math.ceil(
      (parseInt(sidebardata.adults, 10) + parseInt(sidebardata.children, 10)) /
        2
    );
  ...
  const handleChange = (e) => {
    ...
    if (e.target.id === "beds") {
      // Calculate beds based on adults and children
      const totalBeds = Math.ceil(
        (parseInt(sidebardata.adults, 10) +
          parseInt(sidebardata.children, 10)) /
          2
      );
      setSidebardata({ ...sidebardata, beds: totalBeds });
    }
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-7  border-b-2 md:border-r-2 md:min-h-screen">
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2">
            <label
              htmlFor="adults"
              className="text-black whitespace-nowrap font-semibold"
            >
              Adults:
            </label>
            <input
      ...
      <div className="flex-1">
        ...
        <div className="p-7 flex flex-wrap text-center gap-4">
