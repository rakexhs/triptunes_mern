...
export default function Profile() {
  ...
  useEffect(() => {
    // Function to hide the success message after a certain time
    if (updateSuccess) {
  ...
  useEffect(() => {
    // Function to hide the error message after a certain time
    if (error) {
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      {showPropertiesError && (
        <p className="text-red-700 mt-5 text-center">Error showing properties</p>
      )}

      {!showPropertiesError &&
        userProperties !== null &&
        userProperties.length === 0 && (
          <p className="text-red-700 mt-5 text-center">You don't have properties hosted</p>
        )}

      {!showPropertiesError && userProperties && userProperties.length > 0 && (
